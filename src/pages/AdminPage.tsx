...
export default function AdminPage() {
  ...
  async function submitResult(e: FormEvent<HTMLFormElement>, matchId: string) {
    e.preventDefault();
    const form = new FormData(e.currentTarget);
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-white/60">
          Uzupełniaj drużyny w fazie pucharowej, gdy są znane. Potem wpisuj wyniki — punkty
          naliczają się automatycznie.
        </p>
            ...
            <div key={match.id} className="card-pitch space-y-3 p-4">
              ...
              >
                ...
                <input
                  ...
                  max={20}
                  required
                  key={`${match.id}-h-${match.homeScore}`}
